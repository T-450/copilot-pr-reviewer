...
// Register streaming handler after session creation.
session.on(createStreamingHandler());
...
createSession: async () => {
const replySession = await client.createSession(
...
replySession.on(createStreamingHandler());
return replySession;
},
